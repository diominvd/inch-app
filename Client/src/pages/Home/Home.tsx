	...
	return (
		<div className="page" id="home">
			...
			<div style={{display: 'flex', flexDirection: 'row', gap: '6px'}}>
				<Button disabled mode="white" size="medium" onClick={() => console.log('swap')} style={{flex: 1}}>Swap</Button>
				<Button mode="white" size="medium" haptic={["notification", "success"]} onClick={() => console.log('swap')} style={{flex: 1}}>Claim</Button>
				<Button disabled mode="white" size="medium" haptic={["notification", "success"]} onClick={() => console.log('burn')} style={{flex: 1}}>Burn</Button>
			</div>
